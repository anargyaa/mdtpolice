  ...
  return (
    <div className='grid grid-cols-3 grid-rows-2 h-full gap-2'>
      <div className='bg-[#1e1e1e] col-span-2 row-span-2 flex flex-col gap-4 py-2 px-2 min-h-24 rounded-xl overflow-y-auto'>
        ...
        <div className='rounded-lg ring-1 overflow-hidden m-1'>
          <table className='table-auto w-full'>
            <thead className='bg-[#03040f]'>
              <tr className='text-center'>
                <td className='text-sm p-2 ring-1'>No</td>
                <td className='text-sm p-2 ring-1'>Nama Lengkap</td>
                <td className='text-sm p-2 ring-1'>Reason</td>
                <td className='text-sm p-2 ring-1'>Tanggal Penetapan</td>
                <td className='text-sm p-2 ring-1'>Status</td>
              </tr>
            </thead>
            <tbody className='text-center'>
              <tr className=''>
                <td className='text-sm p-2 ring-1'>1</td>
                <td className='text-sm p-2 text-left ring-1'>Jhon Doe</td>
                <td className='text-sm p-2 text-left ring-1'>Penembakan kepada anggota kepolisian</td>
                <td className='text-sm p-2 ring-1'>21 Mei 2024</td>
                <td className='text-sm p-2 ring-1'>On Progress</td>
              </tr>
              <tr className=''>
                <td className='text-sm p-2 ring-1 '>1</td>
                <td className='text-sm p-2 text-left ring-1'>Jhon Doe</td>

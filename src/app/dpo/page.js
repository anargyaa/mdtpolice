          ...
          <table className='table-auto w-full rounded-lg overflow-hidden'>
            <thead className='bg-[#03040f]'>
              <tr className='text-center '>
                <td className='text-sm p-2'>No</td>
                <td className='text-sm p-2'>Nama Lengkap</td>
                <td className='text-sm p-2'>Reason</td>
                <td className='text-sm p-2'>Tanggal Penetapan</td>
            ...
            <tbody className='text-center'>
              <tr>
                ...
                <td className='text-sm p-2 text-left'>Jhon Doe</td>
                <td className='text-sm p-2 text-left'>Penembakan kepada anggota kepolisian</td>
                <td className='text-sm p-2'>21 Mei 2024</td>
